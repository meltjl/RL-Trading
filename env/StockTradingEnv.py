...
class StockTradingEnv(gym.Env):
    ...
    def step(self, action):
        ...
        print('step : {} | reward : {:.2f} | networth : {:.2f} | %return {:.2f}%'.
              format(self.current_step, reward, self.net_worth, (self.net_worth / INITIAL_ACCOUNT_BALANCE) - 1))
    ...
    def _render_to_file(self, filename='render.txt'):
        ...
        file.write('{:.1f}\t{:.2f}\t{:.2f}\t{:.2f}\t{:.2f}\t{:.2f}\t{:.2f}\t{:.2f}\t{:.2f}\n'.
                   format(self.current_step, self.balance, self.shares_held, self.total_shares_sold, self.cost_basis, self.total_sales_value, self.net_worth, self.max_net_worth, profit))
        file.close()
